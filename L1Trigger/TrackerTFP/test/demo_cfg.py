...
process.lr = cms.Sequence( process.TrackerTFPProducerLR + process.TrackerTFPAnalyzerLR + process.TrackerTFPDemonstrator )
process.tt = cms.Path( process.mc + process.dtc + process.gp + process.ht + process.mht + process.lr )
